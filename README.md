...
5. Each week (hint ?xts::endpoints), rebalance to maintain the DV01-neutral position.
...
position.
(d) Residual: the dierence between the total return and the sum of the spread return,
...
You should submit two les: one pdf document and one .R le. Your pdf document should
be a report discussing the results of your analysis. It should include the following sections:
Executive Summary, Introduction, Discussion (broken into several sections), and a Conclu-
sion. You can put the gures and tables either at the end of you document or throughout.
No .R template is provided for this assignment. The .R le should be clearly documented.
You cannot use any packages other than data.table, lubridate, magrittr, tidyverse,
xts and any of their dependencies.
